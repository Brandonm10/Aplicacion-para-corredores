...
function haCorrido()
{
    ...
    else
    {
        ...
        document.getElementById("campo_corredor").
            appendChild(obj_distancia);
    }
}
function noHaCorrido()
{
    ...
    {
    document.getElementById("campo_corredor").
        removeChild(document.getElementById("distancia"));
    }
}
function indicarDatos()
{
    ...
    if (hacorrido)
    {
        ...
        saludo=saludo+" y has corrido una distancia de "+distancia+" km";
    }
    alert(saludo);
}